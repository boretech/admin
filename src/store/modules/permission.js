...
import { useAppStoreWithOut } from './app.js'
import { transformObjToRoute, flatMultiLevelRoutes } from '@/router/helper/routeHelper.js'
import { transformRouteToMenu } from '@/router/helper/menuHelper.js'

import projectSetting from '@/settings/projectSetting.js'

import { PermissionModeEnum } from '@/enums/appEnum.js'

import { asyncRoutes } from '@/router/routes/index.js'
import { ERROR_LOG_ROUTE, PAGE_NOT_FOUND_ROUTE } from '@/router/routes/basic.js'

import { filter } from '@/utils/helper/treeHelper.js'

import { getMenuList } from '@/api/sys/menu.js'
import { getPermCode } from '@/api/sys/user.js'
  ...
  actions: {
    ...
    async buildRoutesAction() {
      ...
      const patchHomeAffix = (routes) => {
        ...
        const patcher = (routes, parentPath = '') => {
