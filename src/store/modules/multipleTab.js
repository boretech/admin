...
import { useGo, useRedo } from '@/hooks/web/usePage.js'
import { Persistent } from '@/utils/cache/persistent.js'

import { PageEnum } from '@/enums/pageEnum.js'
import { PAGE_NOT_FOUND_ROUTE, REDIRECT_ROUTE } from '@/router/routes/basic.js'
import { getRawRoute } from '@/utils/index.js'
import { MULTIPLE_TABS_KEY } from '@/enums/cacheEnum.js'

import projectSetting from '@/settings/projectSetting.js'
import { useUserStore } from '@/store/modules/user.js'

const handleGotoPage = (router) => {
...
export const useMultipleTabWithOutStore = () => useMultipleTabStore(store)
