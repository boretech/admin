...
import { SIDE_BAR_MINI_WIDTH, SIDE_BAR_SHOW_TIT_MINI_WIDTH } from '@/enums/appEnum.js'
import { MenuModeEnum, MenuTypeEnum, TriggerEnum } from '@/enums/menuEnum.js'
import { useFullContent } from '@/hooks/web/useFullContent.js'
...
export const useMenuSetting = () => {
  ...
  const setMenuSetting = (menuSetting) => {
