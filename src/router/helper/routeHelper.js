...
import { getParentLayout, LAYOUT, EXCEPTION_COMPONENT } from '@/router/constant.js'
...
// 将背景对象变成路由对象
export const transformObjToRoute = (routeList) => {
 ...
 * 将多级路由转换为 2 级路由
 */
export const flatMultiLevelRoutes = (routeModules) => {
...
// 路由等级提升
const promoteRouteLevel = (routeModule) => {
...
// 判断级别是否超过2级
const isMultipleRoute = (routeModule) => {
